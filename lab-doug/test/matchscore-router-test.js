...
describe('Testing matchscore-router module, ', function(){
  ...
  describe('Testing GET on api/matchscore/:uuid', function(){
    ...
    it('it should return a matchscore object as res.body', (done) => {
      request.get(`/api/matchscore/${this.tempMatchscore.uuid}`)
      .end((err, res) => {
        expect(res.status).to.equal(200);
  ...
  it('should return a modified matchscore object', function(done) {
    request.put(`/api/matchscore/${this.tempMatchscore.uuid}`)
